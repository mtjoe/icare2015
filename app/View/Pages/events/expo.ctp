	...
	<div style="background: #E1E0EA; padding: 100px 0px;">
		<div class="normal-width">
			...
			<div class="loc" style="width: 50%; float: left; padding-left: 20px; border-left: 1px solid #D1CEDB;">
				<p><span class="imp">10:00 AM</span>  to  <span class="imp">5:00 PM</span></p>
				<p style="font-size: 10px;">Note: Expo officially opens at 10.30</p><br>
				<p>Courtyard</p>
				<p>State Library of Victoria</p>
				<p>328 Swanston Street</p>
				<p>Melbourne VIC 3000</p><br>

				<iframe class="map" width="100%" height="300" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=State%20Library%20of%20Victoria%2C%20Swanston%20Street%2C%20Melbourne%2C%20Victoria%2C%20Australia&key=AIzaSyBnuNrreKPnAfi0_pykIJAeG6GJ4pALaCU"></iframe>
			</div>
			<div class="clear"></div>
		</div>
	</div>
		...
		<div class="normal-width">
			<section id="cd-timeline">
				...
				<div class="cd-timeline-block">
					...
					<div class="cd-timeline-content">
						<h2>Welcoming Note by Project Manager and PPIA President</h2>
				...
				<div class="cd-timeline-block">
					...
					<div class="cd-timeline-content">
						<h2>Expo Officially Closes</h2>
						<span class="cd-date">5.00 PM</span>
					</div> <!-- cd-timeline-content -->
				</div>
				<div class="clear"></div>
			</section>
